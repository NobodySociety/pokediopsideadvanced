...
const u8 gText_DefaultNameStu[] = _("Morgan");
const u8 gText_DefaultNameMilton[] = _("Dom");
const u8 gText_DefaultNameTom[] = _("Ian");
const u8 gText_DefaultNameKenny[] = _("Lóin");
const u8 gText_DefaultNameReid[] = _("Morty");
...
const u8 gText_DefaultNameKimmy[] = _("Kristen");
const u8 gText_DefaultNameTiara[] = _("Allison");
const u8 gText_DefaultNameBella[] = _("Bella");
const u8 gText_DefaultNameJayla[] = _("Selene");
const u8 gText_DefaultNameAllie[] = _("Sarah");
...
const u8 gText_ChoosePokemon[] = _("Press Select to Swap Pokémon.");
